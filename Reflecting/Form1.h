...
namespace Reflecting 
{
	...
	private: 
		...
		static array<String^>^ assemblies =
		{
			...
			"System.Web",
			"Microsoft.Win32",
			"Microsoft.Visual.STLCLR",
			"MySql.Data",
			"MySql.Web",
			"MySql.Data.Entity for EF6",
			"MySql.Data.Entity for EF5",
			"MySql.Fabric.Plugin"
			"stdole",
			"System.Xaml",
			"mscorlib",
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label4->Location = System::Drawing::Point(366, 94);
			...
			this->label5->Location = System::Drawing::Point(788, 94);
			...
			this->lbMethods->Size = System::Drawing::Size(347, 251);
			this->lbMethods->TabIndex = 14;
			// 
			// lbProperties
			// 
			this->lbProperties->FormattingEnabled = true;
			this->lbProperties->Location = System::Drawing::Point(368, 110);
			this->lbProperties->Name = L"lbProperties";
			this->lbProperties->Size = System::Drawing::Size(410, 251);
			this->lbProperties->TabIndex = 15;
			// 
			// lbVariables
			// 
			this->lbVariables->FormattingEnabled = true;
			this->lbVariables->Location = System::Drawing::Point(784, 111);
			this->lbVariables->Name = L"lbVariables";
			this->lbVariables->Size = System::Drawing::Size(505, 251);
			...
			this->ClientSize = System::Drawing::Size(1301, 656);
